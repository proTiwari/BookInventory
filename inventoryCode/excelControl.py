...
def excelControl(allErrorList):
    ...
    try:
        for i in range(j, row_count - 1):
            ...
            ImageUploaderList = ImageUploader(frontCoverImageUrl)
            if not ImageUploaderList[-1]:
                ...
                frontCoverImageUrl = ImageUploaderList[-2]
        ...
        if dimensions[1] == 10:
            ...
            allErrorList.append(f"their should be 10 numbers of columns and you have provided {dimensions[1]}")
            return allErrorList
    except:
        print(f"their should be 10 numbers of columns and you have provided {dimensions[1]}")
